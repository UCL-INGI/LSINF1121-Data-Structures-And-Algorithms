...
public class IncrementalHashTest {
    ...
    public boolean hashCorrectOnWords5InputUpTo3() {
        return correct(1000,100,5,3);
    }


    public boolean hashCorrectOnWords5InputUpTo10() {
        return correct(1000,100,5,10);
    }

    public boolean hashCorrectOnWords5InputUpTo65536() {
        return correct(1000,100,5,65536);
    }

    public boolean timeComplexityOK() {
