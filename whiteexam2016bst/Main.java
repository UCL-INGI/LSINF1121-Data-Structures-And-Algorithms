...
public class Main {
    static private class InstanceConfig {
        ...
        HashSet<BaseNode> wrongTurnsCalled = new HashSet<>();
    ...
    static private class BaseNode implements Node {
        private int value;
    ...
    public static void main(String[] args) {
        ...
        try {
            for (int testNb = 0; testNb < tests.length; testNb++) {
                ...
                BaseNode root = new BaseNode(test[0], info);
                ...
                for (int i = 0; i <= 1000; i++) {
                    ...
                    Integer returned = StudentAnswer.ceil(root, i);
