...
/*
 * Solution of Simon Hardy for the mission 6. 
 * Doesn't use neither Bucket/Radix-Sort nor Union/Find structures, 
 * but gives the same result as the one expected from the students. 
 */
